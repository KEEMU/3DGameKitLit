...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        CharacterState m_currentCharacterState = CharacterState.Ellen;
        enum CharacterState
        {
            Ganda,
            Ellen
        ...
        readonly int m_HashSwitchGanda = Animator.StringToHash("SwitchGanda");
        readonly int m_HashSwitchEllen = Animator.StringToHash("SwitchEllen");
        readonly int m_HashShoot = Animator.StringToHash("ShootAttack");
        ...
        void FixedUpdate()
        {
            ...
            if (m_Input.Attack && canAttack)
            {
                ...
                {
                    case CharacterState.Ellen:
                        m_Animator.SetTrigger(m_HashMeleeAttack);
                        break;
                    case CharacterState.Ganda:
                        m_Animator.SetTrigger(m_HashShoot);
                        break;
                }
            }
            ...
            if (Input.GetKeyDown(KeyCode.LeftShift))
            {
                ...
                {
                    case CharacterState.Ellen:
                        m_currentCharacterState = CharacterState.Ganda;
                        //m_Animator.SetTrigger(m_HashSwitchGanda);
                        break;
                    case CharacterState.Ganda:
                        m_currentCharacterState = CharacterState.Ellen;
                        //m_Animator.SetTrigger(m_HashSwitchEllen);
                        break;
                }
            }
